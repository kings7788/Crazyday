      ...
      <div class="mb-4" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="card">
          <div class="card-header" role="tab" id="headingOne">
            <h5 class="mb-0">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">如何更新您的顯示卡驅動程式？</a>
            </h5>
          </div>

          <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
            <div class="card-body">
              驅動程式是非常重要的軟體之一。它讓您的作業系統和硬體達到溝通運作，擁有最新的驅動程式可以確保您擁有最完整、最新的錯誤修正，優化以及功能。尤其，顯示卡驅動程式經常包含重要的錯誤修正和優化。雖然您的驅動程式基本上都是連同顯示卡一同販售，但是通常在真正裝到電腦上時，其驅動程式已經不是最新的版本。以下建議您，在安裝新的顯示卡或是新電腦時，可參考的更新驅動程式方法。
            </div>
          </div>
        </div>
        <div class="card">
